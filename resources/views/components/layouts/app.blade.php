        ...
        <div class="h-full flex flex-col">
            ...
            <nav class="flex-1 px-4 py-6 space-y-1.5 overflow-y-auto custom-scrollbar">
                ...
                <a href="{{ route('reports.index') }}"
                    class="nav-item {{ request()->routeIs('reports.index') ? 'active' : '' }} flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium {{ request()->routeIs('reports.index') ? 'text-white' : 'text-slate-300 hover:text-white' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="{{ route('due-payments.index') }}"
                    class="nav-item {{ request()->routeIs('due-payments.*') ? 'active' : '' }} flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium {{ request()->routeIs('due-payments.*') ? 'text-white' : 'text-slate-300 hover:text-white' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
