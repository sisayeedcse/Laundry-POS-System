            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-blue-900 mt-2">
                        {{ number_format($this->quickStats['total_customers'], 0) }}
                    </p>
                    <p class="text-xs text-blue-600 mt-1">{{ number_format($this->quickStats['new_customers_this_month'], 0) }} new this month</p>
                </div>
