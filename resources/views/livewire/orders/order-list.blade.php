<div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-6">
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            ...
            <a href="/pos" class="group flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-purple-600 to-purple-700 text-white rounded-xl hover:from-purple-700 hover:to-purple-800 transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-0.5">
    ...
    <div class="mb-6 bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
        ...
        <div class="grid grid-cols-1 gap-4 md:grid-cols-6">
            ...
            <div>
                ...
                <select wire:model.live="statusFilter" class="w-full rounded-lg border-gray-300 focus:border-purple-500 focus:ring-purple-500 text-sm">
            ...
            <div>
                ...
                <select wire:model.live="paymentFilter" class="w-full rounded-lg border-gray-300 focus:border-purple-500 focus:ring-purple-500 text-sm">
            ...
            <div>
                ...
                <input type="date" wire:model.live="dateFrom" class="w-full rounded-lg border-gray-300 focus:border-purple-500 focus:ring-purple-500 text-sm"/>
            </div>
            <div>
                <label class="block text-xs font-medium text-gray-700 mb-1.5">To Date</label>
                <input type="date" wire:model.live="dateTo" class="w-full rounded-lg border-gray-300 focus:border-purple-500 focus:ring-purple-500 text-sm"/>
            </div>
        </div>
        
        @if($search || $statusFilter !== 'all' || $paymentFilter !== 'all' || $dateFrom || $dateTo)
            <div class="mt-4 pt-4 border-t border-gray-200">
                <button wire:click="clearFilters" class="flex items-center gap-2 text-sm text-purple-600 hover:text-purple-700 font-medium">
    ...
    <div class="space-y-4">
        @forelse ($this->orders as $order)
            <div class="bg-white rounded-2xl shadow-sm border border-gray-200 hover:shadow-md transition-all duration-200">
                <div class="p-6">
                    {{-- Order Header --}}
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                        ...
                        <div class="space-y-1">
                            ...
                            <p class="text-lg font-bold text-gray-900">{{ number_format($order->total_amount, 2) }} <span class="text-sm text-gray-600">AED</span></p>
                        </div>
                        ...
                        <div class="space-y-3">
                            <div>
                                ...
                                <select wire:change="updateStatus({{ $order->id }}, $event.target.value)" 
                                    ...
                                    class="w-full rounded-lg border-0 text-xs font-semibold cursor-pointer focus:ring-2 focus:ring-purple-500 px-3 py-2
        ...
        @empty
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-12">
                <div class="flex flex-col items-center text-center">
                    ...
                    <a href="/pos" class="inline-flex items-center gap-2 px-6 py-3 bg-purple-600 text-white rounded-xl hover:bg-purple-700 transition-colors font-medium">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/>
                        </svg>
                        Go to POS
